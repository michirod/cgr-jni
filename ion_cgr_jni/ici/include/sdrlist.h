...
Sm_list_user_data_set(__FILE__, __LINE__, sdr, list, userData)
...
Sm_list_insert(__FILE__, __LINE__, sdr, list, data, compare, arg)
...
Sm_list_insert_after(__FILE__, __LINE__, sdr, elt, data)
...
Sm_list_data_set(__FILE__, __LINE__, sdr, elt, data)
